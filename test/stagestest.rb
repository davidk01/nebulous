...
class TestStages < Minitest::Test
  ...
  def test_file_generation_provisioning
    instances = [Stages::Inline.new('echo hi 1', 1), Stages::Inline.new('echo hi 2', 2),
      ...
      Stages::Directory.new(File.expand_path(File.dirname __FILE__) + '/harness/directory', ['arg1', 'arg2', 'arg3'], 5)]
    ...
    ['stage-1.sh', 'stage-2.sh', 'stage-3.sh', 'stage-4.tar', 'stage-5'].each do |file|
