...
echo "test-capability=true" >> /root/bamboo-agent-home/bin/bamboo-capabilities.properties
echo "ephemeral=true" >> /root/bamboo-agent-home/bin/bamboo-capabilities.properties
